...
]`,description:d(),elements:u(n.createElement(z,{children:"Press me",onPress:e=>{window.alert(U("I was clicked!"))}}))})}function bc(){let e,t,r,i;return l.exports.createElement(g,{title:"Adding an icon",code:`Spectrum.ActionButton [
...
]`,description:d(),elements:u((e=a([(t=[(r=Rl,n.createElement(r,{size:"M"})),(i=u(["children",n.Children.toArray(["I have an airplane icon"])]),n.createElement(v,s(i)))],["children",n.Children.toArray(Array.from(t))]),["onPress",o=>{console.log("Event: ",o)}]]),n.createElement(z,s(e))))})}function Cc(){let e,t,r;return l.exports.createElement(g,{title:"Icon-only",code:`Spectrum.ActionButton [
...
]`,description:d(),elements:u((e=a([["aria-label","Edit"],(t=[(r=jr,n.createElement(r,{size:"S"}))],["children",n.Children.toArray(Array.from(t))]),["onPress",i=>{console.log("Event: ",i)}]]),n.createElement(z,s(e))))})}function Ac(){const e=a(["ActionButtons allow users to perform an action. They\u2019re used for similar, task-based options within a workflow, and are ideal for interfaces where buttons aren\u2019t meant to draw a lot of attention.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/ActionButton.html"})," for more details."]);return l.exports.createElement(M,{title:"ActionButton",description:e,examples:a([l.exports.createElement(yc,null),l.exports.createElement(bc,null),l.exports.createElement(Cc,null)])})}function vc(){return l.exports.createElement(g,{title:"Default example",code:`let action, setAction = React.useState("")
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i,o,c,m,p,h,f,x,y,S,A;const I=V(u("list")),R=I[0];return C((e=[(t=a([["selectionMode","multiple"],["selectedKeys",(_=>Array.from(_))(R)],(r=_=>{_ instanceof Te&&I[1](_)},["onSelectionChange",_=>{const G=_;r(G==="all"?"all":pe(G.values()))}]),["children",[(i=a([["key","grid"],(o=[(c=u(["children",n.Children.toArray(["Grid view"])]),n.createElement(v,s(c)))],["children",n.Children.toArray(Array.from(o))])]),n.createElement(E,s(i))),(m=a([["key","list"],(p=[(h=u(["children",n.Children.toArray(["List view"])]),n.createElement(v,s(h)))],["children",n.Children.toArray(Array.from(p))])]),n.createElement(E,s(m))),(f=a([["key","gallery"],(x=[(y=u(["children",n.Children.toArray(["Gallery view"])]),n.createElement(v,s(y)))],["children",n.Children.toArray(Array.from(x))])]),n.createElement(E,s(f)))]]]),n.createElement(zt,s(t))),(S=Kn(Io("Current selection (controller): %A%P()",[Ct(R)])),A=u(["children",n.Children.toArray([S])]),n.createElement(v,s(A)))],l.exports.createElement(l.exports.Fragment,{},...e)))}))})}function kc(){let e,t,r,i,o,c,m,p,h,f,x,y,S;return l.exports.createElement(g,{title:"With icons",code:`Spectrum.ActionGroup [
    ActionGroup.children [
        Spectrum.Item [
            Item.key "edit2"
            Item.children [
...
]`,description:d(),elements:w(b(()=>{let e,t;return C((e=a([["items",(r=>Array.from(r))([{label:"React",name:"_React"},{label:"Add",name:"_Add"},{label:"Delete",name:"_Delete"}])],["isEmphasized",!0],["selectionMode","single"],(t=r=>{let i,o;switch(r instanceof Te?k(r)?i=1:k(F(r))?(i=0,o=T(r)):i=1:i=1,i){case 0:{console.log("Selection: ",o);break}}},["onSelectionChange",r=>{const i=r;t(i==="all"?"all":pe(i.values()))}]),["children",r=>{let i,o;const c=a([["key",r.name],(i=[(o=u(["children",n.Children.toArray([r.label])]),n.createElement(v,s(o)))],["children",n.Children.toArray(Array.from(i))])]);return n.createElement(E,s(c))}]]),n.createElement(zt,s(e))))}))})}function Tc(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_,G,Q,se,Y;return l.exports.createElement(g,{title:"Collapsing buttons",code:`Spectrum.ActionGroup [
...
]`,description:d(),elements:u((e=a([["overflowMode","collapse"],["maxWidth",250],["children",[(t=a([["key","edit"],["textValue","Edit"],(r=[(i=In,n.createElement(i,{})),(o=u(["children",n.Children.toArray(["Edit"])]),n.createElement(v,s(o)))],["children",n.Children.toArray(Array.from(r))])]),n.createElement(E,s(t))),(c=a([["key","copy"],["textValue","Copy"],(m=[(p=tr,n.createElement(p,{})),(h=u(["children",n.Children.toArray(["Copy"])]),n.createElement(v,s(h)))],["children",n.Children.toArray(Array.from(m))])]),n.createElement(E,s(c))),(f=a([["key","delete"],["textValue","Delete"],(x=[(y=Tn,n.createElement(y,{})),(S=u(["children",n.Children.toArray(["Delete"])]),n.createElement(v,s(S)))],["children",n.Children.toArray(Array.from(x))])]),n.createElement(E,s(f))),(A=a([["key","move"],["textValue","Move"],(I=[(R=Pl,n.createElement(R,{})),(_=u(["children",n.Children.toArray(["Move"])]),n.createElement(v,s(_)))],["children",n.Children.toArray(Array.from(I))])]),n.createElement(E,s(A))),(G=a([["key","duplicate"],["textValue","Duplicate"],(Q=[(se=Ll,n.createElement(se,{})),(Y=u(["children",n.Children.toArray(["Duplicate"])]),n.createElement(v,s(Y)))],["children",n.Children.toArray(Array.from(Q))])]),n.createElement(E,s(G)))]]]),n.createElement(zt,s(e))))})}function Fc(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_,G;return l.exports.createElement(g,{title:"Collapsed with multiple selection",code:`Spectrum.ActionGroup [
...
`,description:d(),elements:u((e=a([(t=wt,["theme",t]),["colorScheme","dark"],(r=[(i=a([["padding",20],(o=[n.createElement(z,{children:"Dark mode!"})],["children",n.Children.toArray(Array.from(o))])]),n.createElement(P,s(i)))],["children",n.Children.toArray(Array.from(r))])]),n.createElement(st,s(e))))})}function Xc(){let e,t,r,i,o,c,m;const p=u(l.exports.createElement("p",{className:"paragraph",children:n.Children.toArray(["You can use a Provider component to define common properties for a group of components within. For example, you can disable multiple components as follows:"])}));return l.exports.createElement(g,{title:"Property groups",code:`// Note: You still need to define an app-level Provider for themeing.
Spectrum.Flex [
    Flex.direction FlexDirection.Column
    Flex.gap (DimValue.Size Size100)
    Flex.alignItems FlexAlignItems.Start
...
]`,description:d(),elements:u((e=a([["width","size-2400"],["aria-label","Options"],["selectionMode","single"],["children",[(t=a([["title","Permissions"],["children",[(r=a([["textValue","Read"],(i=[(o=Yr,n.createElement(o,{size:"S"})),(c=u(["children",n.Children.toArray(["Read"])]),n.createElement(v,s(c))),(m=a([["children",n.Children.toArray(["Read only"])],["slot","description"]]),n.createElement(v,s(m)))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(E,s(r))),(p=a([["textValue","Write"],(h=[(f=In,n.createElement(f,{size:"S"})),(x=u(["children",n.Children.toArray(["Write"])]),n.createElement(v,s(x))),(y=a([["children",n.Children.toArray(["Read and Write Only"])],["slot","description"]]),n.createElement(v,s(y)))],["children",n.Children.toArray(Array.from(h))])]),n.createElement(E,s(p))),(S=a([["textValue","Admin"],(A=[(I=Jl,n.createElement(I,{size:"S"})),(R=u(["children",n.Children.toArray(["Admin"])]),n.createElement(v,s(R))),(_=a([["children",n.Children.toArray(["Full access"])],["slot","description"]]),n.createElement(v,s(_)))],["children",n.Children.toArray(Array.from(A))])]),n.createElement(E,s(S)))]]]),n.createElement(Ee,s(t)))]]]),n.createElement(Re,s(e))))})}function gs(){let e,t,r;return l.exports.createElement(g,{title:"Disabled keys",code:`Spectrum.ListBox [
    ListBox.width (DimValue.Size Size2400)
    ListBox.ariaLabel "Pick your favorite"
...
]`,description:d(),elements:w(b(()=>{let e,t;const r=a([{id:"cut",name:"Cut"},{id:"copy",name:"Copy"},{id:"Paste",name:"Paste"},{id:"replace",name:"Replace"}]);return C((e=a([l.exports.createElement(z,d(),"Edit"),(t=a([["items",(i=>Array.from(i))(r)],["children",i=>n.createElement(E,{key:i.id,children:i.name})]]),n.createElement(re,s(t)))]),l.exports.createElement(le,d(),...e)))}))})}function ks(){return l.exports.createElement(g,{title:"Events",code:`let action, setAction = React.useState("")
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i;const o=V(a(["Sidebar","Console"])),c=o[0];return C((e=[(t=a([["closeOnSelect",!1],["children",[l.exports.createElement(z,d(),"Show"),(r=a([["selectionMode","multiple"],["selectedKeys",c],["onSelectionChange",m=>{o[1](pe(m.values()))}],["children",[n.createElement(E,{key:"Sidebar",children:"Sidebar"}),n.createElement(E,{key:"Searchbar",children:"Searchbar"}),n.createElement(E,{key:"Tools",children:"Tools"}),n.createElement(E,{key:"Console",children:"Console"})]]]),n.createElement(re,s(r)))]]]),n.createElement(le,s(t))),(i=`Current selection (controlled): ${Ct(c)}`,l.exports.createElement("p",{children:[i]}))],l.exports.createElement(l.exports.Fragment,{},...e)))}))})}function Fs(){return l.exports.createElement(g,{title:"Sections",code:`let selected, setSelected = React.useState([ "bold"; "left" ])
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i;const o=V(a(["bold","left"]));return C((e=a([l.exports.createElement(z,d(),"Edit"),(t=a([["selectionMode","multiple"],["selectedKeys",o[0]],["onSelectionChange",c=>{o[1](pe(c.values()))}],["children",[(r=a([["title","Styles"],["children",[n.createElement(E,{key:"bold",children:"Bold"}),n.createElement(E,{key:"underline",children:"Underline"})]]]),n.createElement(Ee,s(r))),(i=a([["title","Align"],["children",[n.createElement(E,{key:"left",children:"Left"}),n.createElement(E,{key:"middle",children:"Middle"}),n.createElement(E,{key:"right",children:"Right"})]]]),n.createElement(Ee,s(i)))]]]),n.createElement(re,s(t)))]),l.exports.createElement(le,d(),...e)))}))})}function _s(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_;return l.exports.createElement(g,{title:"Complex items",code:`Spectrum.MenuTrigger [
    Spectrum.ActionButton [ Html.text "Edit" ]
    Spectrum.Menu [
        Spectrum.Item [
            Item.key "cut"
...
]`,description:d(),elements:u((e=a([l.exports.createElement(z,d(),"Edit"),(t=a([(r=a([["key","cut"],["textValue","Cut"],(i=[(o=Yl,n.createElement(o,{size:"S"})),(c=u(["children",n.Children.toArray(["Cut"])]),n.createElement(v,s(c))),(m=u(["children",n.Children.toArray(["\u2318X"])]),n.createElement(xn,s(m)))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(E,s(r))),(p=a([["key","copy"],["textValue","Copy"],(h=[(f=tr,n.createElement(f,{size:"S"})),(x=u(["children",n.Children.toArray(["Copy"])]),n.createElement(v,s(x))),(y=u(["children",n.Children.toArray(["\u2318C"])]),n.createElement(xn,s(y)))],["children",n.Children.toArray(Array.from(h))])]),n.createElement(E,s(p))),(S=a([["key","paste"],["textValue","Paste"],(A=[(I=Xl,n.createElement(I,{size:"S"})),(R=u(["children",n.Children.toArray(["Paste"])]),n.createElement(v,s(R))),(_=u(["children",n.Children.toArray(["\u2318V"])]),n.createElement(xn,s(_)))],["children",n.Children.toArray(Array.from(A))])]),n.createElement(E,s(S)))]),l.exports.createElement(re,d(),...t))]),l.exports.createElement(le,d(),...e)))})}function Bs(){return l.exports.createElement(g,{title:"Disabled keys",code:`let items = [
    {| name = "tiff"; id = "a1b2c3" |}
    {| name = "png"; id = "g5h1j9" |}
    {| name = "jpg"; id = "p8k3i4" |}
    {| name = "PDF"; id = "j7i3a0" |}
...
]`,description:d(),elements:w(b(()=>{let e,t;const r=a([{id:"a1b2c3",name:"tiff"},{id:"g5h1j9",name:"png"},{id:"p8k3i4",name:"jpg"},{id:"j7i3a0",name:"PDF"}]);return C((e=a([l.exports.createElement(z,d(),"Filter"),(t=a([["items",(i=>Array.from(i))(r)],["disabledKeys",["a1b2c3","p8k3i4"]],["children",i=>n.createElement(E,{children:i.name})]]),n.createElement(re,s(t)))]),l.exports.createElement(le,d(),...e)))}))})}function Ds(){const e=a(["Menus display a list of actions or options that a user can choose.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/Menu.html"})," for more details."]);return l.exports.createElement(M,{title:"Menu",description:e,examples:a([l.exports.createElement(vs,null),l.exports.createElement(ws,null),l.exports.createElement(ks,null),l.exports.createElement(Is,null),l.exports.createElement(Ts,null),l.exports.createElement(Fs,null),l.exports.createElement(_s,null),l.exports.createElement(Bs,null)])})}function Vs(){return l.exports.createElement(g,{title:"Events",code:`let isOpen, setIsOpen = React.useState(false)
...
]`,description:d(),elements:u((e=a([["gap","size-100"],(t=[(r=a([["align","start"],["children",[(i=u(["children",n.Children.toArray(["Edit"])]),n.createElement(z,s(i))),(o=a([n.createElement(E,{key:"cut",children:"Cut"}),n.createElement(E,{key:"copy",children:"Copy"}),n.createElement(E,{key:"paste",children:"Paste"})]),l.exports.createElement(re,d(),...o))]]]),n.createElement(le,s(r))),(c=a([["align","end"],["direction","top"],["shouldFlip",!1],["children",[(m=u(["children",n.Children.toArray(["View"])]),n.createElement(z,s(m))),(p=a([n.createElement(E,{key:"sidebar",children:"Sidebar"}),n.createElement(E,{key:"options",children:"Page options"}),n.createElement(E,{key:"edit",children:"Edit panel"})]),l.exports.createElement(re,d(),...p))]]]),n.createElement(le,s(c))),(h=a([["align","start"],["direction","start"],["children",[(f=u(["children",n.Children.toArray(["Edit"])]),n.createElement(z,s(f))),(x=a([n.createElement(E,{key:"cut",children:"Cut"}),n.createElement(E,{key:"copy",children:"Copy"}),n.createElement(E,{key:"paste",children:"Paste"})]),l.exports.createElement(re,d(),...x))]]]),n.createElement(le,s(h))),(y=a([["align","end"],["direction","end"],["children",[(S=u(["children",n.Children.toArray(["View"])]),n.createElement(z,s(S))),(A=a([n.createElement(E,{key:"sidebar",children:"Sidebar"}),n.createElement(E,{key:"options",children:"Page options"}),n.createElement(E,{key:"edit",children:"Edit panel"})]),l.exports.createElement(re,d(),...A))]]]),n.createElement(le,s(y)))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))})}function Ms(){return l.exports.createElement(g,{title:"Open and selection",code:`let isOpen, setIsOpen = React.useState(false)
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i,o,c,m,p,h,f,x;const y=V(!1),S=V(d());return C((e=a([["isOpen",y[0]],["onOpenChange",y[1]],["children",[l.exports.createElement(z,d(),"View"),(t=a([["selectionMode","multiple"],["selectedKeys",S[0]],["onSelectionChange",A=>{S[1](pe(A.values()))}],["children",[(r=a([["key","side"],["textValue","Sidebar"],(i=[(o=u(["children",n.Children.toArray(["Sidebar"])]),n.createElement(v,s(o)))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(E,s(r))),(c=a([["key","options"],["textValue","Page options"],(m=[(p=u(["children",n.Children.toArray(["Page options"])]),n.createElement(v,s(p)))],["children",n.Children.toArray(Array.from(m))])]),n.createElement(E,s(c))),(h=a([["key","edit"],["textValue","Edit panel"],(f=[(x=u(["children",n.Children.toArray(["Edit panel"])]),n.createElement(v,s(x)))],["children",n.Children.toArray(Array.from(f))])]),n.createElement(E,s(h)))]]]),n.createElement(re,s(t)))]]]),n.createElement(le,s(e))))}))})}function zs(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_;return l.exports.createElement(g,{title:"Long press",code:`Spectrum.MenuTrigger [
...
]`,description:d(),elements:u((e=a([["trigger","longPress"],["children",[(t=a([["aria-label","Crop tool"],["onPress",G=>{window.alert(U("Cropping!"))}],(r=[(i=Zl,n.createElement(i,{}))],["children",n.Children.toArray(Array.from(r))])]),n.createElement(z,s(t))),(o=a([(c=a([["textValue","Crop rotate"],(m=[(p=Ql,n.createElement(p,{})),(h=u(["children",n.Children.toArray(["Crop rotate"])]),n.createElement(v,s(h)))],["children",n.Children.toArray(Array.from(m))])]),n.createElement(E,s(c))),(f=a([["textValue","Slice"],(x=[(y=ei,n.createElement(y,{})),(S=u(["children",n.Children.toArray(["Slice"])]),n.createElement(v,s(S)))],["children",n.Children.toArray(Array.from(x))])]),n.createElement(E,s(f))),(A=a([["textValue","Clone stamp"],(I=[(R=ti,n.createElement(R,{})),(_=u(["children",n.Children.toArray(["Clone stamp"])]),n.createElement(v,s(_)))],["children",n.Children.toArray(Array.from(I))])]),n.createElement(E,s(A)))]),l.exports.createElement(re,d(),...o))]]]),n.createElement(le,s(e))))})}function Rs(){const e=a(["The MenuTrigger serves as a wrapper around a Menu and its associated trigger, linking the Menu's open state with the trigger's press state.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/MenuTrigger.html"})," for more details."]);return l.exports.createElement(M,{title:"MenuTrigger",description:e,examples:a([l.exports.createElement(Vs,null),l.exports.createElement(Ns,null),l.exports.createElement(Ms,null),l.exports.createElement(zs,null)])})}function Ps(){let e,t,r,i,o,c,m,p;return l.exports.createElement(g,{title:"Default example",code:`Spectrum.TableView [
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I;const R=V(a(["soccer","baseball"])),_=R[0];return C((e=a([["gap","size-300"],(t=[(r=a([["label","Favorite sports (uncontrolled)"],["defaultValue",["soccer","baseball"]],(i=[(o=a([["value","soccer"],["children",n.Children.toArray(["Soccer"])]]),n.createElement($,s(o))),(c=a([["value","baseball"],["children",n.Children.toArray(["Baseball"])]]),n.createElement($,s(c))),(m=a([["value","basketball"],["children",n.Children.toArray(["Basketball"])]]),n.createElement($,s(m)))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(Ue,s(r))),(p=a([["direction","column"],["gap","size-200"],(h=[(f=a([["label","Favorite sports (controlled)"],["value",Array.from(_)],["onChange",G=>{R[1](pe(G))}],(x=[(y=a([["value","soccer"],["children",n.Children.toArray(["Soccer"])]]),n.createElement($,s(y))),(S=a([["value","baseball"],["children",n.Children.toArray(["Baseball"])]]),n.createElement($,s(S))),(A=a([["value","basketball"],["children",n.Children.toArray(["Basketball"])]]),n.createElement($,s(A)))],["children",n.Children.toArray(Array.from(x))])]),n.createElement(Ue,s(f))),(I=`Selected: ${Nn(", ",_)}`,l.exports.createElement("p",{children:[I]}))],["children",n.Children.toArray(Array.from(h))])]),n.createElement(B,s(p)))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))}))})}function Ys(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_,G,Q,se,Y,me;return l.exports.createElement(g,{title:"Labeling",code:`Spectrum.Flex [
Flex.gap (DimValue.Size Size300)
Flex.wrap true
Flex.children [
    Spectrum.CheckboxGroup [
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i;const o=a([{children:"Arma virumque cano, Troiae qui primus ab oris.",id:1,name:"Founding of Rome"},{children:"Senatus Populusque Romanus.",id:2,name:"Monarchy and Republic"},{children:"Alea jacta est.",id:3,name:"Empire"}]),c=V(1);return C((e=[(t=`Current tab id: ${c[0]}`,l.exports.createElement("p",{children:[t]})),(r=a([["aria-label","History of Ancient Rome"],["items",(m=>Array.from(m))(o)],["onSelectionChange",c[1]],(i=[n.createElement(tn,{children:m=>{const p=m.name;return n.createElement(E,{children:p})}}),n.createElement(nn,{children:m=>{const p=m.children;return n.createElement(E,{children:p})}})],["children",n.Children.toArray(Array.from(i))])]),n.createElement(rn,s(r)))],l.exports.createElement(l.exports.Fragment,{},...e)))}))})}function fu(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R;return l.exports.createElement(g,{title:"Icons in tabs",code:`Spectrum.Tabs [
    Tabs.ariaLabel "History of Ancient Rome"
    Tabs.children [
        Spectrum.TabList [
            Spectrum.Item [
...
]`,description:d(),elements:u((e=a([["aria-label","History of Ancient Rome"],(t=[(r=a([(i=a([["key","FoR"],(o=[(c=ni,n.createElement(c,{})),(m=u(["children",n.Children.toArray(["Founding of Rome"])]),n.createElement(v,s(m)))],["children",n.Children.toArray(Array.from(o))])]),n.createElement(E,s(i))),(p=a([["key","MaR"],(h=[(f=ri,n.createElement(f,{})),(x=u(["children",n.Children.toArray(["Monarchy and Republic"])]),n.createElement(v,s(x)))],["children",n.Children.toArray(Array.from(h))])]),n.createElement(E,s(p))),(y=a([["key","Emp"],(S=[(A=li,n.createElement(A,{})),(I=u(["children",n.Children.toArray(["Empire"])]),n.createElement(v,s(I)))],["children",n.Children.toArray(Array.from(S))])]),n.createElement(E,s(y)))]),l.exports.createElement(tn,d(),...r)),(R=a([n.createElement(E,{key:"FoR",children:"Arma virumque cano, Troiae qui primus ab oris."}),n.createElement(E,{key:"MaR",children:"Senatus Populusque Romanus."}),n.createElement(E,{key:"Emp",children:"Alea jacta est."})]),l.exports.createElement(nn,d(),...R))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(rn,s(e))))})}function xu(){return l.exports.createElement(g,{title:"Selection",code:`let tabs = [
...
]`,description:d(),elements:u((e=a([l.exports.createElement(z,d(),"Save"),n.createElement(Rt,{title:"Low disk space!",variant:"warning",primaryActionLabel:"Confirm",children:`You are running low on disk space.
...
]`,description:d(),elements:u((e=a([l.exports.createElement(z,d(),"Exit"),n.createElement(Rt,{title:"Register profile",variant:"information",primaryActionLabel:"Register",secondaryActionLabel:"Reminder me later",cancelLabel:"Cancel",children:`You have not saved your profile information 
...
]`,description:d(),elements:u((e=a([["isDismissable",!0],(t=[(r=u(["children",n.Children.toArray(["Status"])]),n.createElement(z,s(r))),(i=a([(o=u(["children",n.Children.toArray(["Status"])]),n.createElement(J,s(o))),l.exports.createElement(Z,d()),l.exports.createElement(K,d(),"Printer Status: Connected")]),l.exports.createElement(ye,d(),...i))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(ie,s(e))))})}function ku(){let e,t;return l.exports.createElement(g,{title:"Complex UI",code:`Spectrum.DialogTrigger [
...
]`,description:d(),elements:u((e=a([(t=u(["children",n.Children.toArray(["Register"])]),n.createElement(z,s(t))),r=>{let i,o,c,m,p,h,f,x,y,S,A,I,R;const _=a([["size","L"],(i=[(o=u((c=a([["alignItems","center"],["gap","size-100"],(m=[(p=Yr,n.createElement(p,{size:"S"})),(h=u(["children",n.Children.toArray(["Register for newsletter"])]),n.createElement(v,s(h)))],["children",n.Children.toArray(Array.from(m))])]),n.createElement(B,s(c)))),l.exports.createElement(J,d(),...o)),(f=u((x=u(l.exports.createElement("a",{href:"//example.com",target:"_blank",children:n.Children.toArray(["What is this?"])})),l.exports.createElement(je,d(),...x))),l.exports.createElement(ir,d(),...f)),l.exports.createElement(Z,d()),(y=u((S=a([n.createElement(O,{label:"First Name",placeholder:"John",autoFocus:!0}),n.createElement(O,{label:"Last Name",placeholder:"Smith"}),n.createElement(O,{label:"Street Address",placeholder:"123 Any Street"}),n.createElement(O,{label:"City",placeholder:"San Francisco"})]),l.exports.createElement(xt,d(),...S))),l.exports.createElement(K,d(),...y)),(A=u((I=u(["children",n.Children.toArray(["I want to receive updates for exclusive offers in my area."])]),n.createElement($,s(I)))),l.exports.createElement(or,d(),...A)),(R=a([n.createElement(H,{variant:"secondary",onPress:G=>{r()},children:"Cancel"}),n.createElement(H,{variant:"cta",onPress:G=>{r()},children:"Register"})]),l.exports.createElement(ze,d(),...R))],["children",n.Children.toArray(Array.from(i))])]);return n.createElement(ye,s(_))}]),l.exports.createElement(ie,d(),...e)))})}function Iu(){let e,t;return l.exports.createElement(g,{title:"Hero image",code:`Spectrum.DialogTrigger [
...
]`,description:d(),elements:u((e=a([(t=u(["children",n.Children.toArray(["Upload"])]),n.createElement(z,s(t))),r=>{let i,o,c;const m=a([n.createElement(Xr,{slot:"hero",alt:"",src:"https://i.imgur.com/Z7AzH2c.png",objectFit:"cover"}),(i=u(["children",n.Children.toArray(["Upload file"])]),n.createElement(J,s(i))),l.exports.createElement(Z,d()),(o=u(["children",n.Children.toArray(["Are you sure you want to upload this file?"])]),n.createElement(K,s(o))),(c=a([n.createElement(H,{variant:"secondary",onPress:p=>{r()},children:"Cancel"}),n.createElement(H,{variant:"cta",onPress:p=>{r()},children:"Confirm"})]),l.exports.createElement(ze,d(),...c))]);return l.exports.createElement(ye,d(),...m)}]),l.exports.createElement(ie,d(),...e)))})}function Tu(){return l.exports.createElement(g,{title:"Events",code:`let alertSave = fun (close) ->
    close()
...
]`,description:d(),elements:u((e=a([["type","popover"],(t=[(r=u(["children",n.Children.toArray(["Disk Status"])]),n.createElement(z,s(r))),(i=a([(o=u(["children",n.Children.toArray(["C://"])]),n.createElement(J,s(o))),l.exports.createElement(Z,d()),(c=u((m=u(["children",n.Children.toArray(["50% disk space remaining."])]),n.createElement(v,s(m)))),l.exports.createElement(K,d(),...c))]),l.exports.createElement(ye,d(),...i))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(ie,s(e))))})}function Mu(){let e,t,r,i,o,c,m;return l.exports.createElement(g,{title:"Tray dialog",code:`Spectrum.DialogTrigger [
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i,o,c,m,p,h;const f=xr(void 0);return C((e=a([["gap","size-1000"],(t=[(r=a([["type","popover"],["targetRef",f],(i=[(o=u(["children",n.Children.toArray(["Trigger"])]),n.createElement(z,s(o))),(c=a([(m=u(["children",n.Children.toArray(["The heading"])]),n.createElement(J,s(m))),l.exports.createElement(Z,d()),(p=u((h=u(["children",n.Children.toArray(["This is a popover anchored to the span"])]),n.createElement(v,s(h)))),l.exports.createElement(K,d(),...p))]),l.exports.createElement(ye,d(),...c))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(ie,s(r))),l.exports.createElement("span",{ref:f,style:{width:140,textAlign:"center"},children:n.Children.toArray(["Popover appears over here"])})],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))}))})}function Ru(){let e,t,r,i,o,c,m;return l.exports.createElement(g,{title:"Placement",code:`Spectrum.DialogTrigger [
    DialogTrigger.type' DialogTriggerType.Popover
...
]`,description:d(),elements:u((e=a([["type","popover"],["placement","right top"],(t=[(r=u(["children",n.Children.toArray(["Trigger"])]),n.createElement(z,s(r))),(i=a([(o=u(["children",n.Children.toArray(["The Heading"])]),n.createElement(J,s(o))),l.exports.createElement(Z,d()),(c=u((m=u(["children",n.Children.toArray(["This is a popover placed to the right of its trigger and offset so the arrow is at the top of the dialog."])]),n.createElement(v,s(m)))),l.exports.createElement(K,d(),...c))]),l.exports.createElement(ye,d(),...i))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(ie,s(e))))})}function Pu(){let e,t,r,i,o,c,m;return l.exports.createElement(g,{title:"Offset and cross offset",code:`Spectrum.DialogTrigger [
    DialogTrigger.type' DialogTriggerType.Popover
...
]`,description:d(),elements:u((e=a([["type","popover"],["placement","top"],["offset",50],(t=[(r=u(["children",n.Children.toArray(["Trigger"])]),n.createElement(z,s(r))),(i=a([(o=u(["children",n.Children.toArray(["Offset"])]),n.createElement(J,s(o))),l.exports.createElement(Z,d()),(c=u((m=u(["children",n.Children.toArray(["Offset by an additional 50px."])]),n.createElement(v,s(m)))),l.exports.createElement(K,d(),...c))]),l.exports.createElement(ye,d(),...i))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(ie,s(e))))})}function Lu(){return l.exports.createElement(g,{title:"Events",code:`let isOpen, setIsOpen = React.useState(false)
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i,o,c,m,p,h,f,x;const y=V(!1);return C((e=a([["alignItems","center"],["gap","size-100"],(t=[(r=a([["type","popover"],["placement","top"],["onOpenChange",y[1]],(i=[(o=u(["children",n.Children.toArray(["Whispers"])]),n.createElement(z,s(o))),(c=a([(m=u(["children",n.Children.toArray(["Whispers and DMs"])]),n.createElement(J,s(m))),l.exports.createElement(Z,d()),(p=u((h=u(["children",n.Children.toArray(["You have 0 new messages."])]),n.createElement(v,s(h)))),l.exports.createElement(K,d(),...p))]),l.exports.createElement(ye,d(),...c))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(ie,s(r))),(f=`Current open state: ${y[0]}`,x=u(["children",n.Children.toArray([f])]),n.createElement(v,s(x)))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))}))})}function Gu(){const e=a(["DialogTrigger serves as a wrapper around a Dialog and its associated trigger, linking the Dialog's open state with the trigger's press state. Additionally, it allows you to customize the type and positioning of the Dialog.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/DialogTrigger.html"})," for more details."]);return l.exports.createElement(M,{title:"DialogTrigger",description:e,examples:a([l.exports.createElement(Nu,null),l.exports.createElement(Mu,null),l.exports.createElement(zu,null),l.exports.createElement(Ru,null),l.exports.createElement(Pu,null),l.exports.createElement(Lu,null)])})}function $u(){let e,t,r,i,o;return l.exports.createElement(g,{title:"Default example",code:`Spectrum.TooltipTrigger [
...
]`,description:d(),elements:u((e=a([["delay",0],(t=[(r=a([["aria-label","Edit Name"],(i=[(o=jr,n.createElement(o,{}))],["children",n.Children.toArray(Array.from(i))])]),n.createElement(z,s(r))),n.createElement(Ye,{children:"Change Name"})],["children",n.Children.toArray(Array.from(t))])]),n.createElement(Xe,s(e))))})}function Hu(){let e,t,r,i,o,c;return l.exports.createElement(g,{title:"Warmup / Cooldown",code:`Spectrum.Flex [
    Flex.gap (DimValue.Size Size200)
    Flex.children [
...
]`,description:d(),elements:u((e=a([["gap","size-200"],(t=[(r=a([(i=u(["children",n.Children.toArray(["Hover me"])]),n.createElement(z,s(i))),n.createElement(Ye,{children:"I come up after a delay."})]),l.exports.createElement(Xe,d(),...r)),(o=a([(c=u(["children",n.Children.toArray(["Then hover me"])]),n.createElement(z,s(c))),n.createElement(Ye,{children:"If you did it quickly, I appear immediately."})]),l.exports.createElement(Xe,d(),...o))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))})}function Ou(){let e,t;return l.exports.createElement(g,{title:"Tooltip placement",code:`Spectrum.TooltipTrigger [
...
]`,description:d(),elements:u((e=a([["placement","end"],(t=[n.createElement(z,{["aria-label"]:"Foo",children:"Placement"}),n.createElement(Ye,{children:"In left-to-right, this is on the right. In right-to-left, this is on the left."})],["children",n.Children.toArray(Array.from(t))])]),n.createElement(Xe,s(e))))})}function Wu(){let e,t,r;return l.exports.createElement(g,{title:"Offset and cross offset",code:`Spectrum.TooltipTrigger [
    TooltipTrigger.offset 50
    TooltipTrigger.children [
        Spectrum.ActionButton "Offset"
        Spectrum.Tooltip "This will shift up..."
    ]
]`,description:d(),elements:u((e=a([["offset",50],(t=[(r=u(["children",n.Children.toArray(["Offset"])]),n.createElement(z,s(r))),n.createElement(Ye,{children:"This will shift up..."})],["children",n.Children.toArray(Array.from(t))])]),n.createElement(Xe,s(e))))})}function qu(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A;return l.exports.createElement(g,{title:"Visual variants",code:`Spectrum.Flex [
    Flex.direction FlexDirection.Row
    Flex.gap (DimValue.Size Size100)
    Flex.children [
        Spectrum.TooltipTrigger [
...
]`,description:d(),elements:u((e=a([["direction","row"],["gap","size-100"],(t=[(r=a([(i=a([["aria-label","Approve"],(o=[(c=ai,n.createElement(c,{}))],["children",n.Children.toArray(Array.from(o))])]),n.createElement(z,s(i))),n.createElement(Ye,{variant:"positive",showIcon:!0,children:"Approve workflow"})]),l.exports.createElement(Xe,d(),...r)),(m=a([(p=a([["aria-label","Information"],(h=[(f=ci,n.createElement(f,{}))],["children",n.Children.toArray(Array.from(h))])]),n.createElement(z,s(p))),n.createElement(Ye,{variant:"info",showIcon:!0,children:"Show the more information menu"})]),l.exports.createElement(Xe,d(),...m)),(x=a([(y=a([["aria-label","Danger"],(S=[(A=Tn,n.createElement(A,{}))],["children",n.Children.toArray(Array.from(S))])]),n.createElement(z,s(y))),n.createElement(Ye,{variant:"negative",showIcon:!0,children:"Dangerous action"})]),l.exports.createElement(Xe,d(),...x))],["children",n.Children.toArray(Array.from(t))])]),n.createElement(B,s(e))))})}function Uu(){const e=a(["Display container for Tooltip content. Has a directional arrow dependent on its placement.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/Tooltip.html"})," for more details."]);return l.exports.createElement(M,{title:"Tooltip",description:e,examples:a([l.exports.createElement($u,null),l.exports.createElement(Hu,null),l.exports.createElement(Ou,null),l.exports.createElement(Wu,null),l.exports.createElement(qu,null)])})}function ju(){let e,t,r,i,o;return l.exports.createElement(g,{title:"Default example",code:`Spectrum.ContextualHelp [
...
]`,description:d(),elements:w(b(()=>{let e,t,r,i;const o=a([{id:1,name:"Aerospace"},{id:2,name:"Mechanical"},{id:3,name:"Civil"},{id:4,name:"Biomedical"},{id:5,name:"Nuclear"},{id:6,name:"Industrial"},{id:7,name:"Chemical"},{id:8,name:"Chemical"},{id:9,name:"Electrical"}]),c=V(""),m=V(0),p=m[0]|0;return C((e=[(t=`Current selected major id: ${p}`,l.exports.createElement("p",{children:[t]})),(r=`Current input text: ${c[0]}`,l.exports.createElement("p",{children:[r]})),(i=a([["label","Pick an engineering major"],["defaultItems",(h=>Array.from(h))(o)],["selectedKey",p],["onSelectionChange",h=>{m[1](h)}],["onInputChange",h=>{c[1](h)}],["children",h=>{const f=h.name;return n.createElement(E,{children:f})}]]),n.createElement(Ze,s(i)))],l.exports.createElement(l.exports.Fragment,{},...e)))}))})}function ld(){let e,t,r,i,o,c,m,p,h,f,x,y,S,A,I,R,_,G,Q,se,Y;return l.exports.createElement(g,{title:"Complex items",code:`Spectrum.ComboBox [
...
]`,description:d(),elements:u((e=a([["label","Select action"],["children",[(t=a([["textValue","Add to queue"],(r=[(i=si,n.createElement(i,{})),(o=u(["children",n.Children.toArray(["Add to queue"])]),n.createElement(v,s(o))),(c=a([["slot","description"],["children",n.Children.toArray(["Add to current watch queue"])]]),n.createElement(v,s(c)))],["children",n.Children.toArray(Array.from(r))])]),n.createElement(E,s(t))),(m=a([["textValue","Add review"],(p=[(h=In,n.createElement(h,{})),(f=u(["children",n.Children.toArray(["Add review"])]),n.createElement(v,s(f))),(x=a([["slot","description"],["children",n.Children.toArray(["Post a review for the episode"])]]),n.createElement(v,s(x)))],["children",n.Children.toArray(Array.from(p))])]),n.createElement(E,s(m))),(y=a([["textValue","Subscribe to series"],(S=[(A=Kr,n.createElement(A,{})),(I=u(["children",n.Children.toArray(["Subscribe to series"])]),n.createElement(v,s(I))),(R=a([["slot","description"],["children",n.Children.toArray(["Add series to your subscription list and be notified when a new episode airs"])]]),n.createElement(v,s(R)))],["children",n.Children.toArray(Array.from(S))])]),n.createElement(E,s(y))),(_=a([["textValue","Report"],(G=[(Q=St,n.createElement(Q,{})),(se=u(["children",n.Children.toArray(["Report"])]),n.createElement(v,s(se))),(Y=a([["slot","description"],["children",n.Children.toArray(["Report an issue/violation"])]]),n.createElement(v,s(Y)))],["children",n.Children.toArray(Array.from(G))])]),n.createElement(E,s(_)))]]]),n.createElement(Ze,s(e))))})}function id(){const e=a(["ComboBoxes combine a text entry with a picker menu, allowing users to filter longer lists to only the selections matching a query.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/ComboBox.html"})," for more details.",l.exports.createElement("br",{}),l.exports.createElement("br",{}),"Please note that the following examples require the you to open ",l.exports.createElement("em",{children:["Fable.Core.JsInterop"]})," in order to access the dynamic operator (?)."]);return l.exports.createElement(M,{title:"ComboBox",description:e,examples:a([l.exports.createElement(Zu,null),l.exports.createElement(Qu,null),l.exports.createElement(ed,null),l.exports.createElement(td,null),l.exports.createElement(nd,null),l.exports.createElement(rd,null),l.exports.createElement(ld,null)])})}function od(){let e;return l.exports.createElement(g,{title:"Default example",code:`Spectrum.Picker [
...
]`,description:d(),elements:u((e=a([["width",200],["borderColor","hover"],["borderWidth","thicker"],["padding","size-250"],["borderRadius","medium"],["backgroundColor",{base:U("static-green-400"),S:U("label-gray"),M:U("static-blue-300"),L:U("static-red-400")}],(t=[n.createElement(z,{children:"Click me!"})],["children",n.Children.toArray(Array.from(t))])]),n.createElement(P,s(e))))})}function op(){const e=a(["View is a general purpose container with no specific semantics that can be used for custom styling purposes. It supports Spectrum style props to ensure consistency with other Spectrum components.",l.exports.createElement("br",{}),l.exports.createElement("br",{})," Check the official ",l.exports.createElement("a",{children:n.Children.toArray(["documentation"]),href:"https://react-spectrum.adobe.com/react-spectrum/View.html"})," for more details."]);return l.exports.createElement(M,{title:"View",description:e,examples:u(l.exports.createElement(ip,null))})}function ap(){return l.exports.createElement(g,{title:"Default example",code:`Spectrum.Well [
